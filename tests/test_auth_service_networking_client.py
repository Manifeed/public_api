...
from app.clients.networking import auth_service_networking_client
from app.clients.networking.auth_service_networking_client import AuthServiceNetworkingClient
